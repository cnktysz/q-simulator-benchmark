...
dev1 = qml.device("qulacs.simulator", wires=6, gpu=True)
@qml.qnode(dev1)
...
dev2 = qml.device("qulacs.simulator", wires=8, gpu=True)
@qml.qnode(dev2)
...
dev3 = qml.device("qulacs.simulator", wires=10, gpu=True)
@qml.qnode(dev3)
...
with open('logs/log_pennylane_qulacs_gpu.csv', 'a') as f:
