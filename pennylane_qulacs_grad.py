...
dev1 = qml.device("qulacs.simulator", wires=6)
@qml.qnode(dev1)
...
dev2 = qml.device("qulacs.simulator", wires=8)
@qml.qnode(dev2)
...
dev3 = qml.device("qulacs.simulator", wires=10)
@qml.qnode(dev3)
...
with open('logs/log_pennylane_qulacs.csv', 'a') as f:
